...
public class BotConstants {
    ...
    public static final String MSG_TYPE_SOURCE = "Source";
    public static final String MSG_TYPE_PLAIN = "Plain";
    ...
    public static final String COMM_ADDITION_SCORE = "ADDITION_SCORE";
