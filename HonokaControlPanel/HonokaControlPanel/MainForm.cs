...
namespace HonokaControlPanel
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            //输出当前路径
            textBoxLog.Text += DateTime.Now.ToString("hh:mm:ss") + " - 当前运行目录：" + System.Environment.CurrentDirectory + "\r\n";
            //TODO:检测环境
        ...
        private void buttonStart_Click(object sender, EventArgs e)
        {
            ...
            //启动数据库
            Process startDbProcess = new System.Diagnostics.Process();
            ProcessStartInfo dbStartInfo = new System.Diagnostics.ProcessStartInfo();
            dbStartInfo.WindowStyle = ProcessWindowStyle.Hidden;
            dbStartInfo.FileName = "cmd.exe";
            dbStartInfo.Arguments = "/C  " + System.Environment.CurrentDirectory + "\\pgsql\\bin\\pg_ctl.exe " + "-D " + System.Environment.CurrentDirectory + "\\pgsql\\data" + " -l logfile start";
            ...
            //启动服务器
            Process startSvProcess = new System.Diagnostics.Process();
            ...
            svStartInfo.Arguments = "/C  " + System.Environment.CurrentDirectory + "\\tomcat\\bin\\catalina.bat run";
        ...
        private void buttonStop_Click(object sender, EventArgs e)
        {
            ...
            Process stopSvProcess = new System.Diagnostics.Process();
            ProcessStartInfo svStartInfo = new System.Diagnostics.ProcessStartInfo();
            svStartInfo.WindowStyle = ProcessWindowStyle.Hidden;
            svStartInfo.FileName = "cmd.exe";
            svStartInfo.Arguments = "/C  " + System.Environment.CurrentDirectory + "\\tomcat\\bin\\catalina.bat stop";
            ...
            Process stopDbProcess = new System.Diagnostics.Process();
            ProcessStartInfo dbStartInfo = new System.Diagnostics.ProcessStartInfo();
            dbStartInfo.WindowStyle = ProcessWindowStyle.Hidden;
            dbStartInfo.FileName = "cmd.exe";
            dbStartInfo.Arguments = "/C  " + System.Environment.CurrentDirectory + "\\pgsql\\bin\\pg_ctl.exe " + "-D " + System.Environment.CurrentDirectory + "\\pgsql\\data" + " -m fast stop";
